...
import { AuxilioMedicamento } from "@/database/models/Solicitacao/AuxilioMedicamento";
import { CestaBasica } from "@/database/models/Solicitacao/CestaBasica";
import { VagaCreche } from "@/database/models/Solicitacao/VagaCreche";
import { VagaEscola } from "@/database/models/Solicitacao/VagaEscola";
...
function SolicitacaoForm({ solicitacaoJSON }: Props) {
  ...
  const solicitacao:
    ...
    | VagaCreche
    | VagaEscola
    | null = solicitacaoJSON ? JSON.parse(solicitacaoJSON) : null;
