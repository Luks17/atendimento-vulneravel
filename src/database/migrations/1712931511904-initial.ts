...
export class Initial1712931511904 implements MigrationInterface {
    name = 'Initial1712931511904'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`usuario_session\` (\`id\` varchar(255) NOT NULL, \`expires_at\` datetime NOT NULL, \`usuarioIdId\` char(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`usuario_session\` ADD CONSTRAINT \`FK_27667d1b7913297005aba8577b6\` FOREIGN KEY (\`usuarioIdId\`) REFERENCES \`usuarios\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`usuario_session\` DROP FOREIGN KEY \`FK_27667d1b7913297005aba8577b6\``);
        ...
        await queryRunner.query(`DROP TABLE \`usuario_session\``);
