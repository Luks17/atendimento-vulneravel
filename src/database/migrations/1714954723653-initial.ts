...
export class Initial1714954723653 implements MigrationInterface {
    name = 'Initial1714954723653'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`usuarios\` (\`id\` char(36) NOT NULL, \`nome\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`cpf\` char(14) NOT NULL, \`phone\` char(15) NOT NULL, \`passwd\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_446adfc18b35418aac32ae0b7b\` (\`email\`), UNIQUE INDEX \`IDX_ebebcaef8457dcff6e6d69f17b\` (\`cpf\`), UNIQUE INDEX \`IDX_2514d37d064085405337e3cf0b\` (\`phone\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
